            ...
            <form >
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <button class="btn btn-danger " ><a href="<?php echo e(route('categories')); ?>" style="color: white"><i class="far fa-arrow-alt-circle-left"></i> back</a></button><br><br>
                    </div>
                        ...
                        <table class="article-table table table-striped  ">
                            ...
                            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="article-<?php echo e($row->id); ?>">
                                    ...
                                    <td><a href="<?php echo e(route('category-products',[$row->id])); ?>"><button class="details btn btn-success"  ><i class='far fa-eye'></i> products</button></a></td>
                                    <td><button class="edit-article btn btn-info"  data-toggle="modal" data-target="#edit-modal-article" data-id="<?php echo e($row->id); ?>" data-name="<?php echo e($row->name); ?>"  data-parent="<?php echo e($row->parent_id); ?>"><i class='far fa-edit'></i> update</button></td>
                    ...
                    <div class="modal-dialog modal-dialog-centered" style="max-width:800px;" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php echo e(Form::open(array('id'=>'add-category-form','enctype'=>'multipart/form-data'))); ?>

                                <?php echo e(Form::label('name', 'name ')); ?>

                                <?php echo e(Form::text('name','',['class' => 'form-control'])); ?><br>
                                <?php echo e(Form::label('parent_id', 'parent')); ?>

                                <br>
                                <select class="form-control parent_id"  name="parent_id" style="height: 200px ; width: 100% ;" >
                                </select><br><br>
                                <?php echo e(Form::submit('save',['class' => 'btn btn-dark btn-lg btn-block','id'=>'add-category'])); ?>
                ...
                <div class="modal fade" id="edit-modal-article" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" style="max-width:800px;" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php echo e(Form::open(array('id'=>'edit-category-form','enctype'=>'multipart/form-data'))); ?>
                                ...
                                <?php echo e(Form::submit('save',['class' => 'btn btn-dark btn-lg btn-block','id'=>'edit-category'])); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\fatora-task\resources\views/admin/pages/categories.blade.php ENDPATH**/ ?>