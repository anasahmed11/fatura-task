            ...
            <form >
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <button class="btn btn-danger " ><a href="<?php echo e(route('providers')); ?>" style="color: white"><i class="far fa-arrow-alt-circle-left"></i> back</a></button><br><br>
                    </div>
                        ...
                        <table class="article-table table table-striped  ">
                            ...
                            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="article-<?php echo e($row->id); ?>">
                                    ...
                                    <td>
                                        <button class="add-product btn btn-outline-primary" style="margin-right: 5px" data-toggle="modal" data-target="#add-product-modal" data-id="<?php echo e($row->id); ?>"><i class='fas fa-plus'></i> add</button>
                                        <a href="<?php echo e(route('provider-products',[$row->id])); ?>"><button class="details btn btn-success"  ><i class='far fa-eye'></i> show</button></a>
                                    </td>
                                    <td><button class="edit-article btn btn-info"  data-toggle="modal" data-target="#edit-modal-article" data-id="<?php echo e($row->id); ?>" data-name="<?php echo e($row->name); ?>"  ><i class='far fa-edit'></i> update</button></td>
                    ...
                    <div class="modal-dialog modal-dialog-centered" style="max-width:800px;" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php echo e(Form::open(array('id'=>'add-provider-form','enctype'=>'multipart/form-data'))); ?>

                                <?php echo e(Form::label('name', 'name ')); ?>

                                <?php echo e(Form::text('name','',['class' => 'form-control'])); ?><br><br>
                                <?php echo e(Form::submit('save',['class' => 'btn btn-dark btn-lg btn-block','id'=>'add-provider'])); ?>
                ...
                <div class="modal fade" id="edit-modal-article" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" style="max-width:800px;" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php echo e(Form::open(array('id'=>'edit-provider-form','enctype'=>'multipart/form-data'))); ?>

                                <?php echo e(Form::label('name', 'name ')); ?>

                                <?php echo e(Form::text('name','',['class' => 'form-control','id'=>'name-edit'])); ?><br><br>
                                <?php echo e(Form::submit('save',['class' => 'btn btn-dark btn-lg btn-block','id'=>'edit-provider'])); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\fatora-task\resources\views/admin/pages/providers.blade.php ENDPATH**/ ?>